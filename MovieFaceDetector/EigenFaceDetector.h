...
void Dreamline(char *movieClipPath, char *outputPath, char *haarClassifierPath);
...
int main( int argc, char** argv )
{
  ...
  if( !strcmp(argv[1], "train") ) learn();
							    ...
							    "C:\\TestOutputs", "C:\\OpenCV2.2\\data\\haarcascades\\haarcascade_frontalface_alt_tree.xml");
  else if ( !strcmp(argv[1], "Dreamline") && argc < 4 ) Dreamline( argv[2], argv[3], 
						       "./haarcascades/haarcascade_frontalface_alt_tree.xml");
  else if ( !strcmp(argv[1], "Dreamline") ) Dreamline( argv[2], argv[3],argv[4]);
